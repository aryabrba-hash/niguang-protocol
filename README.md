...
一款渐进式规则切换与干扰抑制训练小游戏。当前 `v0.5.0` 已扩展为 20 关完整主线，并为后续微信小游戏迁移拆分核心玩法与平台能力。

## 在线试玩

[立即开始游戏](https://aryabrba-hash.github.io/niguang-protocol/?v=0.5.0)

## 这版包含什么

- 20 个由“单一规则 → 规则冲突 → 规则切换 → 干扰抑制”逐步推进的关卡
- 后半程设置难度硬上限和 3 个巩固关，生命容错与过关线严格匹配
